    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(getApplicationContext(), ScanCard.class);
...
//                startActivity(i);
    ...
    private void processPayment(){
        ...
        Log.d("Dashboard activity","inside process payment line 80000000000000000");
        ...
        if(requestCode == PAYPAL_REQUEST_CODE){
            if(resultCode == RESULT_OK){
                ...
                if(confirmation != null){
                    try{
                        Log.d("Dashboard activity","inside process payment line 9222222222222222");
                        String paymentDetails = confirmation.toJSONObject().toString(4);
                        startActivity(new Intent(DashboardActivity.this, PaymentDetails.class)
